...
SELECT categoria_id, AVG(preco) AS media_precos_categoria FROM tb_produtos GROUP BY categoria_id ;

SELECT MAX(preco) AS maior_preco FROM tb_produtos;

SELECT MIN(preco) AS maior_preco FROM tb_produtos;

SELECT * FROM tb_produtos INNER JOIN tb_categorias ON tb_produtos.categoria_id = tb_categorias.id;

SELECT descricao, AVG(preco) AS media_precos
